...
export const showAccountInfo = () => {
    ...
    let userTitlesHTML = "";
    if (window.siyuan.user && window.siyuan.user.userTitles && window.siyuan.user.userTitles.length > 0) {
    ...
    const subscriptionHTML = `<div class="b3-chip b3-chip--success"><svg><use xlink:href="#iconVIP"></use></svg>Полный функционал доступен (Open Source)</div>`;
    openModel({
