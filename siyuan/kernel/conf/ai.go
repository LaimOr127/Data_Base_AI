...
type Ollama struct {
	...
	APIMaxContexts int     `json:"apiMaxContexts"`
	APIBaseURL     string  `json:"apiBaseURL"`
	APIKey         string  `json:"apiKey"` // API ключ для Open Router или других провайдеров
}
...
func NewAI() *AI {
	...
	// Инициализация Gemini с API ключом по умолчанию
	gemini := &Gemini{
		APITemperature: 1.0,
		APIMaxContexts: 7,
		APITimeout:     30,
	...
	return &AI{OpenAI: openAI, Gemini: gemini, Ollama: ollama}
}
